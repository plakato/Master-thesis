...
\todo[inline]{Mohla byste v této sekci zmínit i různé slovníky rýmů. Narazil jsem např. na https://en.wikipedia.org/wiki/Rhyme_Genie ale je jich zřejmě velmi mnoho, obzvlášť různých služeb (nevalné kvality) online - výše zmiňujete rhymezone.com. Je-li takovýto slovník volně dostupný, šlo by ho asi přímoĊaře použít i k detekci rýmů, nejen ke generování. Možná bude ale lepší, když v úvodu této sekce naopak vymezíte kritéria, co je pro vás relevantní: např. musí to být open-source, musí to být instalovatelné (ne jen online služba), musí to přímo umět detekovat rýmy v zadaném textu apod. Pro každé kritérium můžete uvést jeden příklad nástroje, který dané kritérium porušuje, ale bude jasné, proĊ tyto nástroje nepopisujete podrobněji.}
