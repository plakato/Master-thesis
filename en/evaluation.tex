...
We calculated the aforementioned scores for all variants of tagger and summed up the results in Tables \ref{reddy_eval} and \ref{my_eval}. They both performed better on the Chicago Poetry Corpus.
...
\begin{table}[h!]
	...
	\midrule
	Rhyme Tagger & 0.9463 & 0.9384 & 0.9635 & 0.9534 \\
